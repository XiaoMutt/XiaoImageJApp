 ...
 * @author Xiao Zhou
 */
public class XiaoImageJApp extends javax.swing.JFrame {

    /**
     * Creates new form XiaoImageJApp
     */
    public XiaoImageJApp() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new XiaoImageJApp().setVisible(true);

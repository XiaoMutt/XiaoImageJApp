...
/**
 *
 * @author N/A ImageJ Autothresholder modified by Xiao Zhou from Fiji source
 * code
 *
 * ImagePlus object
 *
...
//        }
        ...
        if (minBin < maxBin) {
            ...
            } else if (method.equals("MinError(I)")) {
 ...
 /* Background */
    ...
    public static int Otsu(int[] data) {
        ...
        int num_pixels = 0;
        double total_mean;
        /* mean gray-level for the whole image */
        double bcv, term;
        /* between-class variance, scaling term */
        double max_bcv;
        /* max BCV */
        double[] cnh = new double[data.length];
        /* cumulative normalized histogram */
